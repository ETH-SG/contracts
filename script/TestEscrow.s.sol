...
contract EscrowTest is Script {
    ...
    function setUp() public {
        ...
        escrowFactory = EscrowFactory(0xF1B4D344B483592C6EE17fF8C437db69c62b3e77);

        IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48).approve(address(escrowFactory), 10000);
